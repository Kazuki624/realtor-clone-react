               ...
               <div className='flex items-center mb-6'>
                    <div>
                         ...
                         <div className='flex w-full justify-center items-center space-x-6'>
                              <input type="number" id='regular-price' value={regularPrice} onChange={onChange} min='50' max='999999999' required
               ...
               {offer === true && (
                    <div className='flex items-center mb-6'>
                         <div>
                              ...
                              <div className='flex w-full justify-center items-center space-x-6'>
                                   <input type="number" id='discount-price' value={discountedPrice} onChange={onChange} min='50' max='999999999' required={offer}
                                        className='w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-l-slate-600 text-center' />
                                   {type === "rent" && (
                                        <div className=''>
                                             <p className='text-md w-full whitespace-nowrap'>$ / Month</p>
