...
export const CreateListing = () => {
  ...
  return (
    <main className='max-w-md px-2 mx-auto'>
          <h1 className='text-3xl text-center mt-6 font-bold'>Post a property</h1>
          <form onSubmit={onSubmit}>
               ...
               <input type="text" id='name' value={name} onChange={onChange} placeholder='Property with ocean view' maxLength='40' minLength='10' required
               ...
               <p className="text-lg mt-6 font-semibold">Property's address</p>
               <textarea type="text" id='address' value={address} onChange={onChange} placeholder='943 Kiwi Av #413, Guthrie, KY 42234' required
                      className="w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 mb-6" />
               {!geolocationEnabled && (
                    <div className='flex space-x-6 justify-start mb-6'>
                         <div>
